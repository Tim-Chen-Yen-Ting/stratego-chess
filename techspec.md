# 行軍西洋棋 — Technical Specification

Implementation contract for `gamebook.md`. Where this document and the gamebook disagree about **rules**, the gamebook wins. This document is authoritative for **structure, types and APIs**.

Document set:
| File | Role |
|---|---|
| `CLAUDE.md` | Repo map: file roles, code invariants, working conventions, mistakes already made. |
| `gamebook.md` | **The rules.** What is legal. Normative. |
| `notebook_v01.md` | Derivations, emergent interactions, playtest data. Never normative. Gitignored. |
| `strategy_v01.md` | Player-facing攻略 — how to play well. No data, no hedging. Never normative. Gitignored. |
| `fogofwar.md` | Design doc for an unbuilt optional mode, written against `gamebook_v04.md`. Not implemented, not normative. |
| `techspec.md` | This file — structure, types, APIs. |
| `gamebook_v01.md`–`_v05.md`, `plan_v01.md` | Superseded snapshots. Kept for history, gitignored. |
